...
public class ECCAutomation {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("loginContainer:txtUsername")).sendKeys("shadi");
		driver.findElement(By.id("loginContainer:txtUserPasswordforshow")).sendKeys("Test@123");
        ...
        driver.findElement(By.xpath("//*[@id='buttons'] //div[@class='toolbar'] //a[@id='ChequeInfoTagUpdateCell']")).click();
        Thread.sleep(2000);
        driver.findElement(By.xpath("//*[@id='Batches']/tbody/tr[1]/td[1]/table/tbody/tr/td[2]")).click();
        Thread.sleep(1000);
        driver.findElement(By.xpath("//*[@id='BatchInfoApproveCell']")).isEnabled();
        Thread.sleep(3000);
        driver.findElement(By.xpath("//*[@id='BatchInfoApproveCell']")).click();
        Thread.sleep(10000);
        ////////////
        driver.switchTo().defaultContent();
		driver.switchTo().frame("menu");
